...
\begin{table}[tb]
\caption{Error budget for the X gate in the three-level transmon model at $T = \SI{20}{\nano\second}$. Infidelity $\epsilon = 1 - F$ is shown for each noise channel. ``Coherent'' denotes closed-system (unitary) evolution. Control noise entries show the mean infidelity over 100 random realizations with the indicated relative amplitude noise level.}
\label{tab:error_budget}
\begin{ruledtabular}
\begin{tabular}{l ccc}
Error source & Gaussian $\epsilon$ & DRAG $\epsilon$ & GRAPE $\epsilon$ \\
\hline
Coherent        & $2.8\!\times\!10^{-2}$ & $4.9\!\times\!10^{-4}$ & $<\!10^{-15}$ \\
$T_1$ only      & $2.8\!\times\!10^{-2}$ & $7.3\!\times\!10^{-4}$ & $2.1\!\times\!10^{-4}$ \\
$T_2$ only      & $2.8\!\times\!10^{-2}$ & $6.1\!\times\!10^{-4}$ & $5.8\!\times\!10^{-4}$ \\
$T_1 + T_2$     & $2.9\!\times\!10^{-2}$ & $8.4\!\times\!10^{-4}$ & $7.2\!\times\!10^{-4}$ \\
Noise 1\%       & $2.8\!\times\!10^{-2}$ & $6.6\!\times\!10^{-4}$ & $2.4\!\times\!10^{-4}$ \\
Noise 5\%       & $3.4\!\times\!10^{-2}$ & $5.6\!\times\!10^{-3}$ & $5.9\!\times\!10^{-3}$ \\
\end{tabular}
\end{ruledtabular}
\end{table}

The error budget reveals a striking three-tier structure. For Gaussian pulses, coherent error dominates at all noise levels: adding full decoherence changes the infidelity from $2.8 \times 10^{-2}$ to $2.9 \times 10^{-2}$ (a relative change of only $\sim\!4\%$), indicating that Gaussian gate error is overwhelmingly due to leakage and rotation error, not decoherence.
...
Table~\ref{tab:error_budget_2level} shows the corresponding two-level error budget for comparison. In the two-level model (no leakage), Gaussian and GRAPE perform identically---both are decoherence-limited. This confirms that GRAPE's advantage in the three-level model arises entirely from leakage suppression, not from a superior two-level rotation. DRAG in two levels shows coherent infidelity of $2.8 \times 10^{-2}$, dominated by the parasitic quadrature rotation that serves no purpose without a $\ket{2}$ state.

\begin{table}[tb]
\caption{Error budget for the X gate in the two-level model at $T = \SI{20}{\nano\second}$. Without leakage, Gaussian and GRAPE achieve identical decoherence-limited performance. DRAG's infidelity is dominated by the parasitic quadrature rotation.}
\label{tab:error_budget_2level}
\begin{ruledtabular}
\begin{tabular}{l ccc}
Error source & Gaussian $\epsilon$ & DRAG $\epsilon$ & GRAPE $\epsilon$ \\
\hline
Coherent        & $<\!10^{-8}$           & $2.8\!\times\!10^{-2}$ & 0 \\
$T_1$ only      & $2.5\!\times\!10^{-4}$ & $2.8\!\times\!10^{-2}$ & $2.4\!\times\!10^{-4}$ \\
$T_2$ only      & $3.8\!\times\!10^{-4}$ & $2.8\!\times\!10^{-2}$ & $3.8\!\times\!10^{-4}$ \\
$T_1 + T_2$     & $5.8\!\times\!10^{-4}$ & $2.8\!\times\!10^{-2}$ & $5.7\!\times\!10^{-4}$ \\
Noise 1\%       & $2.3\!\times\!10^{-4}$ & $2.8\!\times\!10^{-2}$ & $2.3\!\times\!10^{-4}$ \\
Noise 5\%       & $5.7\!\times\!10^{-3}$ & $3.4\!\times\!10^{-2}$ & $5.7\!\times\!10^{-3}$ \\
\end{tabular}
\end{ruledtabular}
\end{table}
...
The robustness results reveal a nuanced picture. GRAPE shows excellent amplitude robustness: even at $\pm 5\%$ amplitude error, the minimum fidelity remains 0.994, the best among all three methods. DRAG also shows strong amplitude robustness (minimum 0.990), significantly outperforming Gaussian (minimum 0.965).
